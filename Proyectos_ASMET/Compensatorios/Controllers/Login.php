<?php 
	...
	class Login extends Controllers{
		...
		public function login(){
			$data['page_tag'] = "Incio de Sesión";
			$data['page_title'] = "Incio de Sesión";
			$data['page_name'] = "Incio de Sesión";
			$data['page_icono'] = "fa-user";
			$data['page_acceso'] = "login";
