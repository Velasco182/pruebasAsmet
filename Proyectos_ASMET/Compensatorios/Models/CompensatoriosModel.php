...
class CompensatoriosModel extends Oracle{
	...
	public function insertCompensatorio(
		...
		string $COM_ESTADO) {
			...
			/*TO_DATE(:COM_FECHA_INICIO, 'YYYY/MM/DD HH24:MI:SS'),
        		TO_DATE(:COM_FECHA_FIN, 'YYYY/MM/DD HH24:MI:SS'),
				TO_TIMESTAMP(TO_DATE(:COM_FECHA_INICIO, 'DD/MM/YYYY HH:II AM'), 'YYYY/MM/DD HH24:MI:SS'),
				TO_TIMESTAMP(TO_DATE(:COM_FECHA_FIN, 'DD/MM/YYYY HH:II AM'), 'YYYY/MM/DD HH24:MI:SS'),*/
