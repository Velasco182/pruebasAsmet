          ...
          <div class="tile">
            <div class="tile-body">
              <form id="formRol" name="formRol">
                <input type="hidden" id="idRol" name="idRol" value="" autocomplete="off">
                ...
                <div class="form-group">
                  <label class="control-label" for="txtCodigo">Código Rol</label>
                  <input class="form-control" id="txtCodigo" name="txtCodigo" type="text" placeholder="Código del rol" required autocomplete="off">
                </div>
                <div class="form-group">
